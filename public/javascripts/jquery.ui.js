...
(function(c, l) {
	...
	c.widget("ui.dialog", {
		...
		_createButtons: function(a) {
			var b = this,
				d = false,
				e = c("<div></div>").addClass("ui-dialog-buttonpane ui-helper-clearfix"),
...
(function(d, C) {
	...
	d.extend(M.prototype, {
		...
		_generateHTML: function(a) {
			...
			e = e ? '<div class="ui-datepicker-buttonpane ">' + (c ? h : "") + (this._isInRange(a, s) ? '<a class="uibutton  ui-datepicker-current " onclick="DP_jQuery_' + B + ".datepicker._gotoToday('#" + a.id + "');\">" + j + "</a>" : "") + (c ? "" : h) + "</div>" : "";
